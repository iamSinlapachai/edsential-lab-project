...
const topics: Topic[] = [
  {
    ...
    category: "Foundation",
    description:
      "📊 **Excel** คือเครื่องมือพื้นฐานที่สุดแต่ทรงพลังมากสำหรับ Data Analyst คลิปนี้จะสอนเทคนิคที่จำเป็น เช่น Pivot Table, VLOOKUP, และฟังก์ชันจัดการข้อมูลต่างๆ ที่ต้องใช้จริง",
  ...
  },
  {
    ...
    description:
      "🗄️ **SQL (Structured Query Language)** คือภาษาที่ใช้ดึงและจัดการข้อมูลจากฐานข้อมูล เป็นทักษะที่ขาดไม่ได้ คลิปนี้สอนตั้งแต่ SELECT พื้นฐานไปจนถึงการ JOIN ตาราง",
  ...
  },
  {
    ...
    description:
      "🎨 **Data Visualization** ไม่ใช่แค่การทำกราฟสวย แต่คือการเลือกกราฟให้ถูกกับข้อมูลเพื่อสื่อสาร Insight ให้เข้าใจง่าย คลิปนี้จะปูพื้นฐานหลักการทำ Visualization ที่ถูกต้อง",
  ...
  },
  {
    ...
    category: "BI Tools",
    description:
      "📈 **Business Intelligence Tools** ช่วยให้เราสร้าง Dashboard แบบ Interactive ได้ คลิปนี้สอนใช้งาน Power BI ตั้งแต่ import ข้อมูลจนถึงสร้างรายงานสรุปผู้บริหาร",
  ...
  },
  {
    ...
    description:
      "🐍 **Python** คือภาษาเขียนโปรแกรมยอดนิยมสำหรับงาน Data คลิปนี้จะสอน Python พื้นฐานที่จำเป็น เพื่อเตรียมพร้อมสำหรับการจัดการข้อมูลที่ซับซ้อนกว่า Excel",
  ...
  },
  {
    ...
    description:
      "🐼 **Pandas** คือ Library ใน Python ที่เป็นหัวใจของการทำ Data Cleaning และ Manipulation คลิปนี้จะสอนวิธีจัดการ DataFrame เปลี่ยนข้อมูลดิบให้พร้อมใช้งาน",
  ...
  },
  {
    ...
    category: "Math & Logic",
    description:
      "📐 **Statistics** หรือสถิติ คือแก่นแท้ของการวิเคราะห์ข้อมูล คลิปนี้จะทบทวนสถิติเบื้องต้นที่ Data Analyst ต้องรู้ เช่น Mean, Median, Mode และ Standard Deviation",
  ...
  },
  {
    ...
    description:
      "🔍 **EDA** คือกระบวนการทำความเข้าใจข้อมูลก่อนเริ่มสร้างโมเดลหรือทำรายงาน คลิปนี้จะพาทำ Workshop วิเคราะห์ข้อมูลจริงเพื่อหา Insight ที่ซ่อนอยู่",
  ...
  },
  {
    ...
    description:
      "🤖 **Machine Learning** ช่วยให้เราทำนายอนาคตจากข้อมูลได้ คลิปนี้ปูพื้นฐาน Concept ของ ML แบบเข้าใจง่ายๆ สำหรับผู้เริ่มต้นสาย Data",
      ...
      <div className="relative pt-20 pb-16 px-4 text-center overflow-hidden">
        ...
        <div className="relative z-10 max-w-4xl mx-auto">
          ...
          <p className="text-lg md:text-xl text-gray-400 max-w-2xl mx-auto leading-relaxed">
            เส้นทางสู่การเป็นนักวิเคราะห์ข้อมูลมืออาชีพ ตั้งแต่ Excel พื้นฐาน
            สู่ SQL, Python และ Business Intelligence
            พร้อมคลิปสอนภาษาไทยที่คัดมาแล้ว
          </p>
        </div>
      </div>
