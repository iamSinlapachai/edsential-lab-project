...
interface PrivacySection {
  title: string;
  summary: string;
  details?: PrivacyDetail[];
}

const privacyContent: { effectiveDate: string; sections: PrivacySection[] } = {
  ...
  sections: [
    // ... (เนื้อหาส่วนต่างๆ เหมือนเดิม) ...
    {
      ...
      summary:
        "เราเก็บรวบรวมข้อมูลหลายประเภทเพื่อวัตถุประสงค์ที่หลากหลายในการให้บริการและปรับปรุงบริการของเราแก่คุณ",
      details: [
        {
          subtitle: "1.1 ข้อมูลส่วนบุคคล (Personal Data)",
          content:
            "รวมถึงแต่ไม่จำกัดเพียง ชื่อ, ที่อยู่อีเมล, ตำแหน่งงาน, และประวัติการใช้งานที่คุณให้มาเมื่อลงทะเบียนหรือแก้ไขโปรไฟล์",
        },
        {
          subtitle: "1.2 ข้อมูลการใช้งาน (Usage Data)",
          content:
            "ข้อมูลนี้จะถูกรวบรวมโดยอัตโนมัติ ซึ่งอาจรวมถึงที่อยู่ IP, ประเภทเบราว์เซอร์, หน้าบริการที่เราเข้าชม, เวลาและวันที่ของการเข้าชม และเวลาที่ใช้ในหน้าเหล่านั้น",
        },
      ],
    },
    {
    ...
    },
    {
      ...
      summary:
        "ความปลอดภัยของข้อมูลของคุณมีความสำคัญต่อเรา แต่โปรดจำไว้ว่าไม่มีวิธีการส่งข้อมูลทางอินเทอร์เน็ตหรือวิธีการจัดเก็บทางอิเล็กทรอนิกส์ใดที่ปลอดภัย 100% เรามุ่งมั่นที่จะใช้วิธีการที่ยอมรับในเชิงพาณิชย์เพื่อปกป้องข้อมูลส่วนบุคคลของคุณ",
    },
    {
      title: "4. สิทธิของคุณภายใต้ GDPR (ถ้ามี)",
      summary:
        "หากคุณเป็นผู้อยู่อาศัยในเขตเศรษฐกิจยุโรป (EEA) คุณมีสิทธิ์ในการป้องกันข้อมูลบางประการ",
      details: [
