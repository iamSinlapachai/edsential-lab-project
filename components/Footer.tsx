    ...
    return (
        <footer className='bg-[#0f172a] text-gray-300 py-20 '>
            <div className='container mx-auto px-8 max-w-7xl flex flex-col' >
                ...
                <div className='flex flex-col md:flex-row mx-auto md:mx-0 text-center md:text-start justify-center md:justify-between my-10 '>
                    ...
                    <div className='mb-10 md:mb-0'>
                        ...
                        <div className='font-light'>© Edsential Lab • Terms of Service • Privacy Policy</div>
                    </div>
